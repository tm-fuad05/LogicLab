    ...
    <header className="h-14 border-b border-line bg-main sticky top-0 z-30 flex items-center justify-between px-3 sm:px-8 transition-colors">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        >
          ...
          <span className="text-xs hidden sm:inline font-poppins">GitHub</span>
        </a>

        {/* Mobile Sidebar Hamburger Toggle */}
        <button
          onClick={onToggleSidebar}
          className="lg:hidden p-2 text-txt-main border border-line hover:bg-sidebar flex items-center justify-center"
